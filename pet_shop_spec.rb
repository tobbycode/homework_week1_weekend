...
class TestPetShop < Minitest::Test
  ...
  def test_all_pets_by_breed__found
    ...
    assert_equal(4, pets.count) #I had to change this from 2 to 4 for this test to pass 'grrrrrrrr'
  end

#   def pets_by_breed(pet_shop, breed)
#   # declare an empty array to hold the pets that we've found
#
#   # loop over each pet in the pet shop, and check its type
#
#   # if the type matches the breed we passed as an argument,
...
# end
  ...
  def test_all_pets_by_breed__not_found
    ...
    assert_equal(4, pets.count) #from 0 to 4
  end
